...
namespace T3v\T3vNavigations\Tests\Functional\Frontend;
 ...
 *
 * @package T3v\T3vNavigations\Tests\Functional\Frontend
 */
class RenderingTest extends FunctionalTestCase
{
    ...
    public function templateIsRendered(): void
    {
        ...
        if ($response->getStatusCode() === 200) {
            ...
            self::assertEquals('Home | T3v Navigations', $titleTag->nodeValue);
    ...
    protected function setUp(): void
    {
        ...
        $this->setUpFrontend(1, 'T3v Navigations');
    }
}
