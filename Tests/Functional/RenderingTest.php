<?php
namespace T3v\T3vNavigations\Tests\Functional;
 ...
 *
 * @package T3v\T3vNavigations\Tests\Functional
 */
class RenderingTest extends FunctionalTestCase {
  ...
  public function templateIsRendered() {
    ...
    $expectedDom->loadHTML('<h1>T3v Navigations</h1>');
  ...
  protected function setUp() {
    ...
    $this->setUpFrontendRootPage(1, ['EXT:t3v_navigations/Tests/Functional/Fixtures/Frontend/Basic.typoscript']);
  }
