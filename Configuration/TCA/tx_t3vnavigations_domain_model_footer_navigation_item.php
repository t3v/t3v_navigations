<?php
/**
 * The footer navigation item TCA configuration.
 *
...
return [
    ...
    'columns' => [
        ...
        'name' => [
            'label' => $lll . 'tx_t3vnavigations_domain_model_footer_navigation_item.name',
            'config' => [
                'type' => 'input',
                'max' => 255,
                'eval' => 'trim, required',
        ...
        'label' => [
            'label' => $lll . 'tx_t3vnavigations_domain_model_footer_navigation_item.label',
            'config' => [
                'type' => 'input',
                'max' => 255,
                'eval' => 'trim',
        ...
        'type' => [
            'label' => $lll . 'tx_t3vnavigations_domain_model_footer_navigation_item.type',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'items' => [
                    [$lll . 'tx_t3vnavigations_domain_model_footer_navigation_item.type.default', 'default']
                ],
                'default' => 'default',
                'behaviour' => [
        ...
        'handle' => [
            'label' => $lll . 'tx_t3vnavigations_domain_model_footer_navigation_item.handle',
            'config' => [
                'type' => 'slug',
                'generatorOptions' => [
                    'fields' => ['name'],
        ...
        'page' => [
            'label' => $lll . 'tx_t3vnavigations_domain_model_footer_navigation_item.page',
            'config' => [
                'type' => 'group',
                'internal_type' => 'db',
                'allowed' => 'pages',
        ...
        'link' => [
            'label' => $lll . 'tx_t3vnavigations_domain_model_footer_navigation_item.link',
            'config' => [
                'type' => 'input',
        ...
        'layout' => [
            'label' => $lll . 'tx_t3vnavigations_domain_model_footer_navigation_item.layout',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectCheckBox',
                'items' => [
                    [$lll . 'tx_t3vnavigations_domain_model_footer_navigation_item.layout.default', 'default']
                ],
                'default' => 'default',
                'behaviour' => [
                    'allowLanguageSynchronization' => true
        ...
        'l10n_parent' => [
            ...
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'foreign_table' => 'tx_t3vnavigations_domain_model_footer_navigation_item',
                'foreign_table_where' => 'AND {#tx_t3vnavigations_domain_model_footer_navigation_item}.{#pid}=###CURRENT_PID### AND {#tx_t3vnavigations_domain_model_footer_navigation_item}.{#sys_language_uid} IN (-1,0)',
                'items' => [
                    ['', 0],
                ],
                'default' => 0
    ...
    'ctrl' => [
        'title' => $lll . 'tx_t3vnavigations_domain_model_footer_navigation_item',
        'label' => 'name',
        // 'label_alt' => 'label',
        // 'label_alt_force' => 1,
        ...
        // ],
        // 'thumbnail' => 'thumbnail',
        'iconfile' => "${iconsFolder}/TCA/FooterNavigationItem.svg",
