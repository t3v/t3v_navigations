...
return [
    ...
    'columns' => [
        ...
        'name' => [
            'label' => $lll . 'tx_t3vnavigations_domain_model_quick_navigation_item.name',
            'config' => [
                'type' => 'input',
                'max' => 255,
                'eval' => 'trim, required',
        ...
        'handle' => [
            'label' => $lll . 'tx_t3vnavigations_domain_model_quick_navigation_item.handle',
            'config' => [
                'type' => 'slug',
                'generatorOptions' => [
                    'fields' => ['name'],
        ...
        'layout' => [
            'label' => $lll . 'tx_t3vnavigations_domain_model_quick_navigation_item.layout',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectCheckBox',
                'items' => [
                    // [$lll . 'tx_t3vnavigations_domain_model_quick_navigation_item.layout.default', 'default'],
                    [$lll . 'tx_t3vnavigations_domain_model_quick_navigation_item.layout.button', 'button'],
                    [$lll . 'tx_t3vnavigations_domain_model_quick_navigation_item.layout.block', 'block']
                ],
                'default' => 'default',
                'behaviour' => [
                    'allowLanguageSynchronization' => true
